...
/* harmony import */ var _components_Auth_useAuth__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("cv0R");
...
function Blog(props) {
  const state = Object(_components_Auth_useAuth__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])();
  const auth = state.isAuthorized;

  if (!auth.checkingInProgress && auth.checkResult === "FOUND") {
    return __jsx(_components_BaseLayout__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"], {
      tab: "Blog"
    }, __jsx("div", {
      className: "portfolios_main_wrapper"
    }, __jsx("div", {
    ...
    return __jsx(_components_BaseLayout__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"], {
      ...
      className: "container w-50 mt-navBar"
    }, __jsx("div", {
      className: "jumbotron text-center"
    }, auth.checkingInProgress && auth.checkResult === "NOT_CHECKED" && __jsx(react_bootstrap__WEBPACK_IMPORTED_MODULE_3__["Spinner"], {
      animation: "border",
      role: "status"
    }, __jsx("span", {
      className: "sr-only"
    }, "Loading...")), !auth.checkingInProgress && auth.checkResult === "NOT_FOUND" && "You're Not Authorized to see this page !"))));
  }
