...
// EXTERNAL MODULE: ./static/styles/_mainStyle.scss
var _mainStyle = __webpack_require__("hGNJ");

// EXTERNAL MODULE: ./static/styles/_helperClases.scss
var _helperClases = __webpack_require__("wpzv");

// EXTERNAL MODULE: ./static/styles/_materialDesignInput.scss
var _materialDesignInput = __webpack_require__("mXWX");
...
// CONCATENATED MODULE: ./components/React-Redux/store.js
...
const reducer = (state = myInitialState, action) => {
  switch (action.type) {
    case actionTypes.AUTH_USER:
      {
        const newState = Object(objectSpread["a" /* default */])({}, state, {
...
function initializeStore(initialState = myInitialState) {
  return Object(external_redux_["createStore"])(reducer, initialState, Object(external_redux_devtools_extension_["composeWithDevTools"])(Object(external_redux_["applyMiddleware"])(external_redux_thunk_default.a)));
}
// CONCATENATED MODULE: ./components/React-Redux/with-redux-store.js
  ...
  render() {
    ...
    return (//   <PersistGate loading={null} persistor={persistor}>
      _app_jsx(external_react_redux_["Provider"], {
        store: reduxStore
      }, _app_jsx(Component, pageProps)) //   </PersistGate>
